...
<form name="detailForm" method="post">
			<input type="hidden" name="prodNo" class="ct_input_g"  value="<%=productVO.getProdNo() %>">
			<input type="hidden" name="menu" class="ct_input_g"  value="<%=request.getParameter("menu") %>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="prodDetail" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="10" minLength="6" value="<%=productVO.getProdDetail() %>"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="manuDate"  class="ct_input_g"  value="<%= productVO.getManuDate() %>"
