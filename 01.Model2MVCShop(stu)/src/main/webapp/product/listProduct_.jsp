...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<td></td>
		<td align="left">
				...
				<% if(request.getParameter("menu").equals("manage")){%>
					<a href="/updateProductView.do?prodNo=<%=productVO.getProdNo() %>&menu=<%=request.getParameter("menu") %>">
					<% }else{ %>
					<a href="/getProduct.do?prodNo=<%=productVO.getProdNo() %>&menu=<%=request.getParameter("menu") %>">
					<% }%>
