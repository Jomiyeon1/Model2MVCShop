...
<%	
	...
	System.out.println("listProduct list => "+ list);
		...
		<form name="detailForm" action="/listProduct.do?menu=<%=menu%>"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<input type="text" name="searchKeyword" value="<%=search.getSearchKeyword()%>" class="ct_input_g" style="width: 200px; height: 19px" /></td>
					</td>
					<%
					} else {
					%>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr class="ct_list_pop">
					...
					<td align="left">
						...
						%> <a
						href="/getProduct.do?prodNo=<%=vo.getProdNo()%>"><%=vo.getProdName()%></a>
						<%
						} else {
						%> <a
