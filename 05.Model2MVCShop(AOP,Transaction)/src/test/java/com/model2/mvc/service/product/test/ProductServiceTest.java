...
public class ProductServiceTest {
	...
	public void testAddProduct() throws Exception {
		...
		product.setProdName("55test1Product");
		...
		product = productService.getProduct(10028);

		// ==> console 확인
		System.out.println("***************" + product);

		// ==> API 확인
		Assert.assertEquals("55test1Product", product.getProdName());
...
//		user.setEmail("test@test.com");
	...
	public void testUpdateProduct() throws Exception {
		...
		Assert.assertEquals("라이딩 11회", product.getProdDetail());
